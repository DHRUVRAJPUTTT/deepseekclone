        ...
        >
            <div>
                <div className={`flex ${expand ? 'flex-row gap-10' : 'flex-col items-center gap-8'}`}>
                    ...
                    <div
                        onClick={() => {
                            console.log('Toggling sidebar, current state:', expand);
                            setExpand(!expand);
                        }}
                        className="group relative flex items-center justify-center hover:bg-blue-500/25 transition-all duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer"
                    >
                        <Image
                        ...
                        />
                        <div
                            className={`absolute w-max z-50 ${expand ? 'left-1/2 -translate-x-1/2 top-12' : '-top-12 left-0'
                ...
                >
                    ...
                    />
                    {!expand && (
                        <div className="absolute left-12 top-1/2 -translate-y-1/2 w-max z-50 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none">
                            New chat
            ...
            <div>
                <div className={`flex items-center cursor-pointer group relative ${expand ? "gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg hover:b-white/10 cursor-pointer" : "h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg"}`}>
